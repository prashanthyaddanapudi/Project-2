...
{
    images_array = [];
    for(var i=1; i<=10 ; i++)   // generating new image array every time, easier to update new images.
    {   
        if(keyword == null)
        {  
            images_array.push("Images/hobbies/Rupinderjeet/hobby-Travelling-"+i+".jpg");
            images_array.push("Images/hobbies/Rupinderjeet/hobby-Reading-"+i+".jpg");
            images_array.push("Images/hobbies/Rupinderjeet/hobby-Photography-"+i+".jpg");
        }
        else if(keyword == 'all')
        {
            images_array.push("Images/hobbies/Rupinderjeet/hobby-Travelling-"+i+".jpg");
        ...
        {
            images_array.push("Images/hobbies/Rupinderjeet/hobby-"+keyword+"-"+i+".jpg");   
        }
...
function showhidden()
{
    document.getElementsByClassName('hidden-item1')[0].style.display = 'inline-block';
    document.getElementsByClassName('hidden-item1')[0].style.position = 'absolute';
}

function hidehidden()
{
    document.getElementsByClassName('hidden-item1')[0].style.display = 'none';
    
}

function showdata()
{
    document.getElementsByClassName('hidden-item2')[0].style.display = 'inline-block';
    document.getElementsByClassName('hidden-item2')[0].style.position = 'absolute';  
}

function hidedata()
{
    document.getElementsByClassName('hidden-item2')[0].style.display = 'none';
}

function viewdata()
{
    document.getElementsByClassName('hidden-item3')[0].style.display = 'inline-block';
    document.getElementsByClassName('hidden-item3')[0].style.position = 'absolute';  
}

function disapperdata()
{
    document.getElementsByClassName('hidden-item3')[0].style.display = 'none';
}